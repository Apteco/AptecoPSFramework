    ...
    process {
        ...
        If ( $createTask -eq "0" ) {
            ...
            $taskParams = [Hashtable]@{
                ...
                Trigger = New-ScheduledTaskTrigger -at ([Datetime]::Today.AddDays(1).AddHours($Script:settings.token.dailyTaskSchedule)) -Daily # Starting tomorrow at six in the morning
